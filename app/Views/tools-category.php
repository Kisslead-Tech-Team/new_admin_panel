...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Tools Category List</h1>
        ...
        <div class="modal-dialog  modal-lg  modal-dialog-">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryModelTitle">Add Category</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3">
                                    <div class="form-floating mb-4 floating">
                                        <input class="form-control category_name" id="category_name"
                                            placeholder="Enter the category name" name="category_name">
                                        <label for="category_name"><span class='text-danger'>*</span> Category Name</label>
                                        <span class="error text-danger mt-5 category_name"></span>
                                    </div>
                                </div>
    ...
    <script src="<?= base_url() ?>assets/custom/js/toolscategory.js"></script>
