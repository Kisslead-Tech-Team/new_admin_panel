    ...
    var ke = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: { name: { offsetY: -10, color: "#4b9bfa", fontSize: ".625rem", show: !1 }, value: { offsetY: 5, color: "#4b9bfa", fontSize: ".875rem", show: !0, fontWeight: 600 } },
                },
            },
...
function Xt(e) {
    Q.updateOptions({ colors: ["rgba(" + e + ", 1)", "rgba(35, 183, 229, 0.85)", "rgba(119, 119, 142, 0.05)"] });
}
...
function jt(e) {
    bt.updateOptions({ colors: ["rgba(" + e + ", 1)", "#ededed"] });
}
let N;
function Vt(e) {
            ...
            plugins: [
                {
                    afterUpdate: function (t) {
                        t.getDatasetMeta(0).data.forEach(function (o) {
                            o.round = {
                                x: (t.chartArea.left + t.chartArea.right) / 2,
                                y: (t.chartArea.top + t.chartArea.bottom) / 2,
                    ...
                    afterDraw: (t) => {
                        ...
                        t.getDatasetMeta(0).data.forEach((l) => {
                            ...
                            r.save(),
                                r.translate(l.round.x, l.round.y),
                                (r.fillStyle = l.options.backgroundColor),
                                r.beginPath(),
                                r.arc(l.round.radius * Math.sin(n), l.round.radius * Math.cos(n), l.round.thickness, 0, 2 * Math.PI),
                                r.closePath(),
                                r.fill(),
                                r.restore();
                        });
...
if (yt !== null) {
    yt.innerHTML = "";
    var Ut = {
            series: [{ name: "Total Orders", data: [44, 42, 57, 86, 112, 55, 70, 43, 23, 54, 77, 34] }],
            ...
            plotOptions: { bar: { columnWidth: "25%", distributed: !0, borderRadius: 7 } },
            dataLabels: { enabled: !1 },
            legend: { show: !1 },
            yaxis: {
                title: { style: { color: "#adb5be", fontSize: "12px", fontFamily: "Montserrat, sans-serif", fontWeight: 500, cssClass: "apexcharts-yaxis-label" } },
                labels: {
                    formatter: function (e) {
                        return e.toFixed(0) + "";
                    },
...
function Kt(e) {
    pt.updateOptions({ colors: ["rgba(" + e + ", 0.3)", "rgba(" + e + ", 0.3)", "rgba(" + e + ", 0.3)", "rgba(" + e + ", 0.3)", "rgb(" + e + ")", "rgba(" + e + ", 0.3)", "#e4e7ed", "#e4e7ed", "#e4e7ed", "#e4e7ed", "#e4e7ed", "#e4e7ed"] });
}
...
if (c !== null) {
    ...
    var Qt = {
            ...
            chart: { type: "candlestick", borderRadius: 20, height: 280, toolbar: { show: !1 } },
            plotOptions: { candlestick: { colors: { upward: "rgb(132, 90, 223)", downward: "rgba(132, 90, 223, 0.2)" } } },
            title: { align: "left" },
            grid: { borderColor: "#f2f6f7" },
            xaxis: {
                type: "datetime",
                axisBorder: { show: !1, color: "rgba(119, 119, 142, 0.05)", offsetX: 0, offsetY: 0 },
                axisTicks: { show: !1, borderType: "solid", color: "rgba(119, 119, 142, 0.05)", width: 6, offsetX: 0, offsetY: 0 },
            },
...
function Zt(e) {
    wt.updateOptions({ plotOptions: { candlestick: { colors: { upward: "rgb(" + e + ")", downward: "rgba(" + e + ", 0.2)" } } } });
}
var c = document.getElementById("btc-chart");
if (c !== null) {
    c.innerHTML = "";
    var le = {
            chart: { type: "line", height: 40, width: 120, sparkline: { enabled: !0 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 0, left: 0, blur: 3, color: "#000", opacity: 0.1 } },
            stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 1.5, dashArray: 0 },
            fill: { gradient: { enabled: !1 } },
            series: [{ name: "Value", data: [0, 45, 54, 38, 56, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46] }],
            yaxis: { min: 0, show: !1 },
...
if (c !== null) {
    c.innerHTML = "";
    var ie = {
            chart: { type: "line", height: 20, width: 120, sparkline: { enabled: !0 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 0, left: 0, blur: 3, color: "#000", opacity: 0.1 } },
            stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 1.5, dashArray: 0 },
            fill: { gradient: { enabled: !1 } },
            tooltip: { enabled: !1 },
            series: [{ name: "Value", data: [0, 45, 54, 38, 56, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46] }],
...
if (c !== null) {
    ...
    var ce = {
            ...
            fill: { gradient: { enabled: !1 } },
            tooltip: { enabled: !1 },
            series: [{ name: "Value", data: [0, 45, 54, 38, 56, 24, 65, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46, 31, 37, 39, 62, 51, 35, 41] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#e6533c"],
...
if (c !== null) {
    ...
    var de = {
            ...
            fill: { gradient: { enabled: !1 } },
            tooltip: { enabled: !1 },
            series: [{ name: "Value", data: [61, 27, 54, 43, 19, 46, 31, 37, 39, 0, 45, 54, 38, 56, 24, 65, 35, 27, 93, 53, 62, 51, 35, 41] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#26bf94"],
...
if (c !== null) {
    ...
    var ue = {
            ...
            fill: { gradient: { enabled: !1 } },
            tooltip: { enabled: !1 },
            series: [{ name: "Value", data: [61, 27, 54, 43, 19, 56, 24, 65, 35, 27, 93, 53, 46, 31, 37, 39, 0, 45, 54, 38, 62, 51, 35, 41] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#26bf94"],
...
if (c !== null) {
    ...
    var me = {
            ...
            fill: { gradient: { enabled: !1 } },
            tooltip: { enabled: !1 },
            series: [{ name: "Value", data: [61, 27, 54, 37, 39, 0, 45, 54, 38, 62, 51, 35, 41, 43, 19, 56, 24, 65, 35, 27, 93, 53, 46, 31] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#e6533c"],
...
if (c !== null) {
    ...
    var he = {
            ...
            fill: { gradient: { enabled: !1 } },
            tooltip: { enabled: !1 },
            series: [{ name: "Value", data: [62, 51, 35, 41, 43, 19, 56, 24, 65, 35, 27, 93, 53, 46, 31, 61, 27, 54, 37, 39, 0, 45, 54, 38] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#e6533c"],
...
if (F !== null) {
    ...
    var qe = {
            series: [
                { name: "Basic", data: [75, 78, 38, 39, 38, 73, 73, 53, 53, 16, 16, 53] },
                { name: "Pro", data: [35, 35, 62, 63, 13, 13, 60, 60, 41, 41, 82, 82] },
            ],
            chart: { toolbar: { show: !1 }, height: 285, type: "line", zoom: { enabled: !1 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 5, left: 0, blur: 3, color: "#000", opacity: 0.15 } },
            grid: { borderColor: "#f1f1f1" },
            dataLabels: { enabled: !1 },
            stroke: { width: [2, 2], curve: ["smooth", "smooth"], lineCap: "butt", dashArray: [0, 0] },
            title: { text: void 0 },
            legend: {
                show: !0,
                position: "top",
                ...
                markers: { width: 7, height: 7, strokeWidth: 0, radius: 12, offsetX: 0, offsetY: 0 },
            },
            markers: {
                discrete: [
                    { seriesIndex: 0, dataPointIndex: 5, fillColor: "#305cfc", strokeColor: "#fff", size: 4, shape: "circle" },
                    { seriesIndex: 0, dataPointIndex: 11, fillColor: "#305cfc", strokeColor: "#fff", size: 4, shape: "circle" },
                    { seriesIndex: 1, dataPointIndex: 10, fillColor: "#23b7e5", strokeColor: "#fff", size: 4, shape: "circle" },
                    { seriesIndex: 1, dataPointIndex: 4, fillColor: "#23b7e5", strokeColor: "#fff", size: 4, shape: "circle" },
                ],
                hover: { sizeOffset: 6 },
            },
            yaxis: {
                title: { style: { color: "#adb5be", fontSize: "14px", fontFamily: "poppins, sans-serif", fontWeight: 600, cssClass: "apexcharts-yaxis-label" } },
                labels: {
                    formatter: function (e) {
                        return e.toFixed(0) + "";
                    },
            ...
            xaxis: {
                ...
                axisBorder: { show: !0, color: "rgba(119, 119, 142, 0.05)", offsetX: 0, offsetY: 0 },
                axisTicks: { show: !0, borderType: "solid", color: "rgba(119, 119, 142, 0.05)", width: 6, offsetX: 0, offsetY: 0 },
                labels: { rotate: -90, style: { colors: "#8c9097", fontSize: "11px", fontWeight: 600, cssClass: "apexcharts-xaxis-label" } },
            },
            tooltip: {
                y: [
                    {
...
function er(e) {
    vt.updateOptions({ colors: ["rgb(" + e + ")", "#23b7e5"] });
}
...
if (F !== null) {
    ...
    var qe = {
            ...
            dataLabels: { enabled: !1 },
            legend: { show: !1 },
            stroke: { show: !0, curve: "smooth", lineCap: "round", colors: "#fff", width: 0, dashArray: 0 },
            plotOptions: {
                pie: {
                    expandOnClick: !1,
                    donut: {
                        ...
                        labels: {
                            ...
                            total: { show: !0, showAlways: !0, label: "Total", fontSize: "22px", fontWeight: 600, color: "#495057" },
                        },
                    },
                },
            },
...
function tr(e) {
    xt.updateOptions({ colors: ["rgb(" + e + ")", "#23b7e5"] });
}
var z = document.getElementById("nft-balance-chart");
if (z !== null) {
    z.innerHTML = "";
    var V = {
            chart: { type: "line", height: 40, sparkline: { enabled: !0 } },
            stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 2.5, dashArray: 0 },
            fill: { gradient: { enabled: !1 } },
            series: [{ name: "Value", data: [20, 14, 19, 10, 25, 20, 22, 9, 12] }],
            yaxis: { min: 0, show: !1, axisBorder: { show: !1 } },
            xaxis: { show: !1, axisBorder: { show: !1 } },
            colors: ["rgb(132, 90, 223)"],
        },
...
if (z !== null) {
    ...
    var or = {
            series: [
                { name: "Price", data: [20, 38, 38, 72, 55, 63, 43, 76, 55, 80, 40, 80] },
                { name: "Volume", data: [85, 65, 75, 38, 85, 35, 62, 40, 40, 64, 50, 89] },
            ],
            chart: { height: 336, type: "line", zoom: { enabled: !1 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 5, left: 0, blur: 3, color: "#000", opacity: 0.1 } },
            dataLabels: { enabled: !1 },
            ...
            yaxis: { title: { text: "Statistics", style: { color: "#adb5be", fontSize: "14px", fontFamily: "poppins, sans-serif", fontWeight: 600, cssClass: "apexcharts-yaxis-label" } } },
            xaxis: {
                type: "month",
                categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
                axisBorder: { show: !0, color: "rgba(119, 119, 142, 0.05)", offsetX: 0, offsetY: 0 },
...
function ar(e) {
    St.updateOptions({ colors: ["rgb(" + e + ")", "rgba(" + e + ", 0.3)"] });
}
...
if (D !== null) {
    ...
    var Ae = {
            ...
            chart: { stacked: !0, type: "bar", height: 325 },
            grid: { borderColor: "#f5f4f4", strokeDashArray: 5, yaxis: { lines: { show: !0 } } },
            ...
            yaxis: {
                title: { text: "Growth", style: { color: "#adb5be", fontSize: "14px", fontFamily: "Montserrat, sans-serif", fontWeight: 600, cssClass: "apexcharts-yaxis-label" } },
                axisBorder: { show: !0, color: "rgba(119, 119, 142, 0.05)", offsetX: 0, offsetY: 0 },
                axisTicks: { show: !0, borderType: "solid", color: "rgba(119, 119, 142, 0.05)", width: 6, offsetX: 0, offsetY: 0 },
                labels: {
                    formatter: function (e) {
...
function lr(e) {
    kt.updateOptions({ colors: ["rgb(" + e + ")", "rgba(" + e + ", 0.6)", "rgba(" + e + ", 0.3)", "#ebeff5"] });
}
    ...
    var Ae = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    track: { dropShadow: { enabled: !0, top: 2, left: 0, blur: 2, opacity: 0.15 } },
                    dataLabels: { name: { offsetY: -10, color: "#4b9bfa", fontSize: "16px", show: !1 }, value: { color: "#4b9bfa", fontSize: "30px", show: !0 } },
                },
            },
            stroke: { lineCap: "round" },
            labels: ["Cart"],
...
function nr(e) {
    qt.updateOptions({ colors: ["rgb(" + e + ")"] });
}
if (typeof jsVectorMap < "u") {
    var sr = [
            { name: "Usa", coords: [40.3, -101.38] },
            { name: "India", coords: [20.5937, 78.9629] },
            { name: "Vatican City", coords: [41.9, 12.45] },
            { name: "Canada", coords: [56.1304, -106.3468] },
            { name: "Mauritius", coords: [-20.2, 57.5] },
            { name: "Singapore", coords: [1.3, 103.8] },
            { name: "Palau", coords: [7.35, 134.46] },
            { name: "Maldives", coords: [3.2, 73.22] },
            { name: "São Tomé and Príncipe", coords: [0.33, 6.73] },
        ],
    ...
    D !== null &&
        ...
        new jsVectorMap({
            ...
            markerLabelStyle: { initial: { fontFamily: "Poppins", fontSize: 13, fontWeight: 500, fill: "#35373e" } },
        }));
}
...
if (m !== null) {
    ...
    var ye = {
            ...
            stroke: { show: !0, curve: "straight", lineCap: "butt", colors: void 0, width: 1.5, dashArray: 0 },
            fill: { gradient: { enabled: !1 } },
            series: [{ name: "Value", data: [0, 21, 54, 38, 56, 24, 65] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { show: !1, axisTicks: { show: !1 }, axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#23b7e5"],
        },
...
if (m !== null) {
    m.innerHTML = "";
    var U = {
            chart: { type: "line", height: 45, sparkline: { enabled: !0 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 0, left: 0, blur: 1, color: "#fff", opacity: 0.05 } },
            stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 2, dashArray: 0 },
            fill: { gradient: { enabled: !1 } },
            series: [{ name: "Value", data: [54, 38, 56, 35, 65, 43, 53, 45, 62, 80, 35, 48] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
...
function ir(e) {
    U.updateOptions({ colors: ["rgba(" + e + ", 0.1)"] });
}
...
function cr(e) {
    At.updateOptions({ colors: ["rgba(" + e + ", 1)", "rgba(35, 183, 229, 1)", "rgba(38, 191, 148, 1)", "rgba(245, 184, 73, 1)"] });
}
...
if (m !== null) {
    ...
    var I = {
            series: [
                { name: "Views", type: "column", data: [23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 45, 35] },
                { name: "Followers", type: "line", data: [44, 55, 41, 67, 22, 43, 21, 41, 56, 27, 43, 27] },
            ],
            chart: { toolbar: { show: !1 }, type: "line", height: 250 },
            grid: { borderColor: "#f1f1f1", strokeDashArray: 3 },
            labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
            dataLabels: { enabled: !1 },
            stroke: { width: [1, 1.1], curve: ["straight", "smooth"] },
            legend: { show: !0, position: "top" },
...
function dr(e) {
    Lt.updateOptions({ colors: ["rgba(" + e + ", 1)", "#23b7e5"] });
}
...
if (m !== null) {
    ...
    var I = {
            series: [
                { name: "Session", data: [24, 23, 20, 25, 27, 26, 24, 23, 23, 25, 23, 23], type: "line" },
                { name: "Bounce Rate", data: [20, 23, 26, 22, 20, 26, 28, 26, 22, 27, 25, 26], type: "bar" },
            ],
            chart: { height: 308, zoom: { enabled: !1 } },
            dataLabels: { enabled: !1, show: !0 },
            grid: { borderColor: "#f1f1f1", strokeDashArray: 3 },
            legend: { show: !0, position: "top" },
            plotOptions: { bar: { borderRadius: 5, columnWidth: "40%", dataLabels: { position: "top" } } },
            colors: ["rgb(132, 90, 223)", "#ededed"],
            stroke: { curve: ["smooth", "stepline"], width: [2, 0], columnWidth: "10%" },
            xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], axisBorder: { color: "#e9e9e9" } },
        },
        Bt = new ApexCharts(document.querySelector("#country-sessions"), I);
    Bt.render();
}
function ur(e) {
    Bt.updateOptions({ colors: ["rgb(" + e + ")", "#ededed"] });
}
...
if (m !== null) {
    ...
    var mr = {
            series: [
                { name: "New Users", data: [32, 15, 63, 51, 36, 62, 99, 42, 78, 76, 32, 120] },
                { name: "Sessions", data: [56, 58, 38, 50, 64, 45, 55, 32, 15, 63, 51, 136] },
                { name: "Avg Session Duration", data: [48, 29, 50, 69, 20, 59, 52, 12, 48, 28, 17, 98] },
            ],
            chart: { height: 387, type: "line", toolbar: { show: !1 }, background: "none", fill: "#fff" },
            grid: { borderColor: "#f2f6f7" },
            ...
            yaxis: { show: !1, axisBorder: { show: !1 }, axisTicks: { show: !1 } },
...
function hr(e) {
    Et.updateOptions({ colors: ["rgb(" + e + ")", "#23b7e5", "#f5b849"] });
}
var m = document.getElementById("analytics-followers");
if (m !== null) {
    m.innerHTML = "";
    var I = {
            chart: { height: 120, width: 100, type: "radialBar" },
            series: [48],
            colors: ["#23b7e5"],
            plotOptions: {
                radialBar: {
                    hollow: { margin: 0, size: "50%", background: "#fff" },
                    dataLabels: { name: { offsetY: -10, color: "#4b9bfa", fontSize: "10px", show: !1 }, value: { offsetY: 5, color: "#4b9bfa", fontSize: "12px", show: !0, fontWeight: 800 } },
                },
            },
            stroke: { lineCap: "round" },
            labels: ["Followers"],
...
if (p !== null) {
    ...
    var gr = {
            series: [
                { name: "Projects", type: "column", data: [1.8, 2.5, 2.5, 1.5, 2.5, 2.8, 3.8] },
                { name: "Tasks", type: "column", data: [1.1, 2.2, 3.1, 4, 4.1, 4.9, 6.5] },
                { name: "Revenue", type: "line", data: [20, 29, 37, 35, 44, 43, 50] },
            ],
            chart: { toolbar: { show: !1 }, height: 300, type: "line", stacked: !1, fontFamily: "Poppins, Arial, sans-serif" },
            grid: { borderColor: "#f5f4f4", strokeDashArray: 3 },
            dataLabels: { enabled: !1 },
            title: { text: void 0 },
            xaxis: { categories: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"] },
            yaxis: [
                { show: !0, axisTicks: { show: !0 }, axisBorder: { show: !1, color: "#4eb6d0" }, labels: { style: { colors: "#4eb6d0" } }, title: { text: void 0 }, tooltip: { enabled: !0 } },
                { seriesName: "Projects", opposite: !0, axisTicks: { show: !0 }, axisBorder: { show: !1 }, labels: { style: { colors: "#00E396" } }, title: { text: void 0 } },
                { seriesName: "Revenue", opposite: !0, axisTicks: { show: !0 }, axisBorder: { show: !1 }, labels: { show: !1 }, title: { text: void 0 } },
            ],
            tooltip: { enabled: !0 },
            legend: { show: !0, position: "top", offsetX: 40, fontSize: "13px", fontWeight: "normal", labels: { colors: "#acb1b1" }, markers: { width: 10, height: 10 } },
...
function br(e) {
    It.updateOptions({ colors: ["rgb(" + e + ")", "#ededed", "#23b7e5"] });
}
var p = document.getElementById("user1");
if (p !== null) {
    p.innerHTML = "";
    var fe = {
            chart: { type: "line", height: 20, width: 80, sparkline: { enabled: !0 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 0, left: 0, blur: 3, color: "#000", opacity: 0.1 } },
            grid: { show: !1, xaxis: { lines: { show: !1 } }, yaxis: { lines: { show: !1 } } },
            stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 1.5, dashArray: 0 },
            fill: { gradient: { enabled: !1 } },
            series: [{ name: "Value", data: [54, 38, 56, 24, 65] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { show: !1, axisTicks: { show: !1 }, axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#09ad95"],
...
if (p !== null) {
    ...
    var ge = {
            ...
            stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 1.5, dashArray: 0 },
            fill: { gradient: { enabled: !1 } },
            series: [{ name: "Value", data: [24, 54, 15, 42, 16] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { show: !1, axisTicks: { show: !1 }, axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#fb6b27"],
...
if (p !== null) {
    ...
    var be = {
            ...
            stroke: { show: !0, curve: "smooth", lineCap: "butt", colors: void 0, width: 1.5, dashArray: 0 },
            fill: { gradient: { enabled: !1 } },
            series: [{ name: "Value", data: [15, 42, 16, 44, 24] }],
            yaxis: { min: 0, show: !1 },
            xaxis: { show: !1, axisTicks: { show: !1 }, axisBorder: { show: !1 } },
            yaxis: { axisBorder: { show: !1 } },
            colors: ["#1170e4"],
...
if ($ !== null) {
    ...
    var Le = {
            series: [
                { name: "Designing", data: [44, 55, 41, 67, 22, 43, 44, 55, 41, 67, 22, 43] },
                { name: "Development", data: [13, 23, 20, 8, 13, 27, 13, 23, 20, 8, 13, 27] },
                { name: "SEO", data: [11, 17, 15, 15, 21, 14, 11, 17, 15, 15, 21, 14] },
            ],
            chart: { type: "bar", height: 310, stacked: !0, toolbar: { show: !0 }, zoom: { enabled: !0 } },
            grid: { borderColor: "#f1f1f1", strokeDashArray: 3 },
...
function pr(e) {
    Ct.updateOptions({ colors: ["rgba(" + e + ", 1)", "rgba(" + e + ", 0.5)", "rgba(" + e + ", 0.2)"] });
}
...
function wr(e) {
    Mt.updateOptions({ colors: ["rgb(" + e + ")", "rgba(" + e + ", 0.7)", "rgba(" + e + ", 0.4)", "rgb(243, 246, 248)"] });
}
...
if (w !== null) {
    ...
    var Be = {
            ...
            fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: 0.5, opacityTo: 0.7, stops: [0, 100] } },
        },
...
if (w !== null) {
    ...
    var Be = {
            ...
            chart: { type: "candlestick", borderRadius: 20, height: 350, toolbar: { show: !1 } },
            plotOptions: { candlestick: { colors: { upward: "rgb(132, 90, 223)", downward: "rgb(35, 183, 229)" } } },
            title: { align: "left" },
            grid: { borderColor: "#f1f1f1", strokeDashArray: 3 },
            xaxis: {
                type: "datetime",
...
function Sr(e) {
    Tt.updateOptions({ plotOptions: { candlestick: { colors: { upward: "rgb(" + e + ")", downward: "rgb(35, 183, 229)" } } } });
}
...
if (W !== null) {
    ...
    var kr = {
            series: [
                { name: "Earnings", data: [30, 25, 36, 30, 45, 35, 64, 51, 59, 36, 39, 51] },
                { name: "Students", data: [33, 21, 32, 37, 23, 32, 47, 31, 54, 32, 20, 38] },
            ],
            chart: { height: 340, type: "bar" },
            dataLabels: { enabled: !1 },
            stroke: { width: [1.1, 1.1], show: !0, curve: ["smooth", "smooth"] },
            grid: { borderColor: "#f3f3f3", strokeDashArray: 3 },
            xaxis: { axisBorder: { color: "rgba(119, 119, 142, 0.05)" } },
            legend: { show: !1 },
            labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
            markers: { size: 0 },
...
function qr(e) {
    Pt.updateOptions({ colors: ["rgb(" + e + ")", "#e9e9e9"] });
}
...
if (W !== null) {
    ...
    var Ar = {
            series: [
                { name: "Paid", data: [55, 55, 42, 42, 55, 55, 38, 38, 53, 53, 35, 35], type: "line" },
                { name: "UnPaid", data: [35, 35, 46, 46, 35, 35, 48, 48, 33, 33, 38, 38], type: "line" },
            ],
            chart: { height: 270, toolbar: { show: !1 }, background: "none", fill: "#fff" },
            grid: { borderColor: "#f2f6f7" },
            colors: ["rgb(132, 90, 223)", "rgba(230, 83, 60,0.5)"],
            background: "transparent",
            dataLabels: { enabled: !1 },
            stroke: { curve: "smooth", width: 2, dashArray: [0, 5] },
            xaxis: { type: "month", categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Aug", "Sep", "Oct", "Nov", "Dec"] },
            dataLabels: { enabled: !1 },
            legend: { show: !0, position: "top" },
            xaxis: {
                show: !1,
...
function Lr(e) {
    Rt.updateOptions({ colors: ["rgb(" + e + ")", "rgba(230, 83, 60,0.5)"] });
}
var G = document.getElementById("waterTrack");
if (G !== null) {
    G.innerHTML = "";
    var Ee = {
            series: [{ data: [98, 110, 80, 145, 105, 112, 87, 148, 102] }],
            chart: { height: 115, type: "area", fontFamily: "Roboto, Arial, sans-serif", foreColor: "#5d6162", zoom: { enabled: !1 }, sparkline: { enabled: !0 } },
            tooltip: {
                enabled: !0,
                x: { show: !1 },
                y: {
            ...
            colors: ["rgb(132, 90, 223)"],
            stroke: { width: [1] },
            fill: { type: "gradient", gradient: { opacityFrom: 0.5, opacityTo: 0.2, stops: [0, 60] } },
        },
        Ot = new ApexCharts(document.querySelector("#waterTrack"), Ee);
    Ot.render();
}
function Br(e) {
    Ot.updateOptions({ colors: ["rgb(" + e + ")"] });
}
var G = document.getElementById("sleepTrack");
if (G !== null) {
    G.innerHTML = "";
    var Ee = {
            series: [{ data: [102, 148, 87, 112, 105, 145, 80, 110, 98] }],
            chart: { height: 115, type: "area", fontFamily: "Roboto, Arial, sans-serif", foreColor: "#5d6162", zoom: { enabled: !1 }, sparkline: { enabled: !0 } },
            tooltip: {
                enabled: !0,
                x: { show: !1 },
...
(function () {
    ...
    if (o !== null) {
        ...
        var e = {
                ...
                chart: { sparkline: { enabled: !0 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 3, right: 6, blur: 3, color: ["#47bbed"], opacity: 0.2 }, type: "line", height: 20, width: 100 },
                tooltip: {
                    x: { show: !1 },
                    y: {
                        title: {
    ...
    if (o !== null) {
        ...
        var e = {
                ...
                chart: { sparkline: { enabled: !0 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 3, right: 6, blur: 3, color: ["#28D193"], opacity: 0.2 }, type: "line", height: 20, width: 100 },
                tooltip: {
                    x: { show: !1 },
                    y: {
                        title: {
    ...
    if (o !== null) {
        ...
        var e = {
                ...
                chart: { sparkline: { enabled: !0 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 3, right: 6, blur: 3, color: ["#FF534D"], opacity: 0.2 }, type: "line", height: 20, width: 100 },
                tooltip: {
                    x: { show: !1 },
                    y: {
                        title: {
    ...
    if (o !== null) {
        ...
        var e = {
                ...
                chart: { sparkline: { enabled: !0 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 3, right: 6, blur: 3, color: ["#FFBE14"], opacity: 0.2 }, type: "line", height: 20, width: 100 },
                tooltip: {
                    x: { show: !1 },
                    y: {
                        title: {
    ...
    if (o !== null) {
        o.innerHTML = "";
        var e = {
                series: [{ name: "Revenue", data: [55, 55, 52, 52, 55, 55, 58, 58, 53, 53, 55, 55] }],
                ...
                markers: { size: 0 },
                colors: ["#FFBE14"],
                fill: { type: "gradient", gradient: { shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0.7, stops: [0, 100] } },
            },
    ...
    if (typeof jsVectorMap < "u") {
        var n = [
                { name: "Russia", coords: [61, 105], style: { fill: "#28d193" } },
                { name: "Greenland", coords: [72, -42], style: { fill: "#ff8c33" } },
                { name: "Canada", coords: [56, -106], style: { fill: "#ff534d" } },
                { name: "Palestine", coords: [31.5, 34.8], style: { fill: "#ffbe14" } },
                { name: "Brazil", coords: [-14.235, -51.9253], style: { fill: "#4b9bfa" } },
            ],
...
function Ir(e) {
    var t = {
        ...
        chart: { type: "bar", height: 235, toolbar: { show: !1 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 6, left: 6, blur: 3, color: "#000", opacity: 0.05 } },
        plotOptions: {
            bar: {
                columnWidth: "35%",
                borderRadius: 4,
        ...
        dataLabels: { enabled: !1 },
        grid: { show: !1, borderColor: "transparent", padding: { top: 0, right: 0, bottom: 0, left: 0 }, yaxis: { lines: { show: !1 } } },
        xaxis: { categories: ["Mon", "Tues", "Wed", "Thu", "Fri", "Sat", "Sun"], colors: "#fff", axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { rotate: -90, style: { fontFamily: "Inter, sans-serif" } } },
        yaxis: { colors: "#fff", axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 } },
    };
...
function Cr(e) {
    var t = {
        ...
        chart: { height: 348, type: "line", stacked: !1, toolbar: { show: !1 }, dropShadow: { enabled: !0, enabledOnSeries: void 0, top: 7, left: 1, blur: 3, color: "#000", opacity: 0.2 } },
        colors: ["rgba(" + e + ", 1)", "rgba(" + e + ", 0.1)"],
        grid: { borderColor: "#e9edf4", padding: { top: 10, right: 0, bottom: 0, left: 0 } },
        stroke: { width: [2, 2], curve: "smooth", dashArray: [0, 4] },
        labels: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        markers: { size: 4, hover: { size: 5 } },
        fill: { opacity: [0.85, 0.25, 1], gradient: { inverseColors: !1, shadeIntensity: 1, shade: "light", type: "vertical", opacityFrom: 0.85, opacityTo: 0.55, stops: [0, 100, 100, 100] } },
        legend: { show: !0, position: "top", fontFamily: "Inter, sans-serif", markers: { width: 10, height: 10 } },
        xaxis: {
            type: "week",
            axisBorder: { show: !0, color: "rgba(119, 119, 142, 0.05)", offsetX: 0, offsetY: 0 },
            axisTicks: { show: !0, borderType: "solid", color: "rgba(119, 119, 142, 0.05)", width: 6, offsetX: 0, offsetY: 0 },
        ...
        yaxis: {
            title: { style: { color: "#adb5be", fontSize: "14px", fontFamily: "Inter, sans-serif", fontWeight: 600 } },
            labels: {
...
class Pr {
    ...
    init(t, r) {
        (this.reference = t),
            (this.popperTarget = r),
            (this.instance = Popper.createPopper(this.reference, this.popperTarget, { placement: "bottom", strategy: "relative", resize: !0, modifiers: [{ name: "computeStyles", options: { adaptive: !1 } }] })),
    ...
    clicker(t, r, o) {
        g.classList.contains("collapsed") && !r.contains(t.target) && !o.contains(t.target) && this.hide();
    }
    hide() {}
}
class Rr {
    ...
    init() {
        Mr.forEach((t) => {
            this.subMenuPoppers.push(new Pr(t, t.lastElementChild)), this.closePoppers();
        });
    }
    togglePopper(t) {
        window.getComputedStyle(t).visibility === "hidden" && window.getComputedStyle(t).visibility === void 0 ? (t.style.visibility = "visible") : (t.style.visibility = "hidden");
    }
    updatePoppers() {
        this.subMenuPoppers.forEach((t) => {
            (t.instance.state.elements.popper.style.display = "none"), t.instance.update();
        });
    }
    closePoppers() {
        this.subMenuPoppers.forEach((t) => {
...
const Z = (e, t = Ie) => {
    ...
    Ht = (e, t = Ie) => {
        ...
        (e.style.overflow = "hidden"),
            ...
            e.style.removeProperty("margin-bottom"),
            window.setTimeout(() => {
                e.style.removeProperty("height"), e.style.removeProperty("overflow"), e.style.removeProperty("transition-property"), e.style.removeProperty("transition-duration");
            }, t);
    },
    Ft = (e, t = Ie) => {
        ...
        if (
            !(
                (r.getAttribute("data-nav-style") === "menu-hover" && r.getAttribute("data-toggled") === "menu-hover-closed" && window.innerWidth >= 992) ||
                (r.getAttribute("data-nav-style") === "icon-hover" && r.getAttribute("data-toggled") === "icon-hover-closed" && window.innerWidth >= 992)
            ) &&
            e &&
            e.nodeType != 3
        )
            return window.getComputedStyle(e).display === "none" ? Ht(e, t) : Z(e, t);
    };
new Rr();
...
Dr.forEach((e) => {
    e.addEventListener("click", () => {
        ...
        if (
            !(
                (t.getAttribute("data-nav-style") === "menu-hover" && t.getAttribute("data-toggled") === "menu-hover-closed" && window.innerWidth >= 992) ||
                (t.getAttribute("data-nav-style") === "icon-hover" && t.getAttribute("data-toggled") === "icon-hover-closed" && window.innerWidth >= 992)
            )
        ) {
...
(() => {
    ...
    window.innerWidth <= 992 ? t.addEventListener("click", J) : t.removeEventListener("click", J),
        (k = [window.innerWidth]),
        E(),
        e.getAttribute("data-nav-layout") === "horizontal" && window.innerWidth >= 992 ? (b(), t.addEventListener("click", b)) : t.removeEventListener("click", b),
        ...
        !localStorage.getItem("ynexlayout") &&
            ...
            Ce(),
        S(),
        (e.getAttribute("data-nav-style") === "menu-hover" || e.getAttribute("data-nav-style") === "icon-hover") && window.innerWidth >= 992 && b(),
        window.innerWidth < 992 && e.setAttribute("data-toggled", "close");
})();
function O() {
    let e = document.querySelector("html"),
        t = document.querySelector(".main-content");
    k.push(window.innerWidth),
        k.length > 2 && k.shift(),
        k.length > 1 &&
            (k[k.length - 1] < 992 && k[k.length - 2] >= 992 && (t.addEventListener("click", J), E(), S(), t.removeEventListener("click", b)),
            k[k.length - 1] >= 992 &&
                k[k.length - 2] < 992 &&
                (t.removeEventListener("click", J), S(), e.getAttribute("data-nav-layout") === "horizontal" ? (b(), t.addEventListener("click", b)) : t.removeEventListener("click", b), e.removeAttribute("data-toggled"))),
        ee();
}
function J() {
...
function S() {
    ...
    if (window.innerWidth >= 992) {
        if (t === "vertical") {
            switch (
                (g.removeEventListener("mouseenter", T),
                g.removeEventListener("mouseleave", P),
                g.removeEventListener("click", X),
                Y.removeEventListener("click", _),
                document.querySelectorAll(".main-menu li > .side-menu__item").forEach((n) => n.removeEventListener("click", Me)),
                e.getAttribute("data-vertical-style"))
            ) {
                case "closed":
                ...
                case "overlay":
                    e.removeAttribute("data-nav-style"),
                        e.getAttribute("data-toggled") === "icon-overlay-close"
                            ? (e.removeAttribute("data-toggled", "icon-overlay-close"), g.removeEventListener("mouseenter", T), g.removeEventListener("mouseleave", P))
                            : window.innerWidth >= 992
                            ? (localStorage.getItem("ynexlayout") || e.setAttribute("data-toggled", "icon-overlay-close"), g.addEventListener("mouseenter", T), g.addEventListener("mouseleave", P))
                            : (g.removeEventListener("mouseenter", T), g.removeEventListener("mouseleave", P));
                    break;
                case "icontext":
                    e.removeAttribute("data-nav-style"),
                        e.getAttribute("data-toggled") === "icon-text-close"
                            ? (e.removeAttribute("data-toggled", "icon-text-close"), g.removeEventListener("click", X), Y.removeEventListener("click", _))
                            : (e.setAttribute("data-toggled", "icon-text-close"),
                              window.innerWidth >= 992 ? (g.addEventListener("click", X), Y.addEventListener("click", _)) : (g.removeEventListener("click", X), Y.removeEventListener("click", _)));
                    break;
                case "doublemenu":
                    if ((e.removeAttribute("data-nav-style"), e.getAttribute("data-toggled") === "double-menu-open"))
                        e.setAttribute("data-toggled", "double-menu-close"),
                            document.querySelector(".slide-menu") &&
                                document.querySelectorAll(".slide-menu").forEach((u) => {
                                    u.classList.contains("double-menu-active") && u.classList.remove("double-menu-active");
                                });
                    else {
                        let n = document.querySelector(".side-menu__item.active");
                        n &&
                            (e.setAttribute("data-toggled", "double-menu-open"),
                            n.nextElementSibling ? n.nextElementSibling.classList.add("double-menu-active") : document.querySelector("html").setAttribute("data-toggled", "double-menu-close"));
                    }
                    Xr();
                    break;
                case "detached":
                    e.getAttribute("data-toggled") === "detached-close"
                        ? (e.removeAttribute("data-toggled", "detached-close"), g.removeEventListener("mouseenter", T), g.removeEventListener("mouseleave", P))
                        : (e.setAttribute("data-toggled", "detached-close"),
                          window.innerWidth >= 992 ? (g.addEventListener("mouseenter", T), g.addEventListener("mouseleave", P)) : (g.removeEventListener("mouseenter", T), g.removeEventListener("mouseleave", P)));
                    break;
                case "default":
            ...
            setTimeout(() => {
                document.querySelector("html").getAttribute("data-toggled") == "open" &&
                    ...
                    document.querySelector("#responsive-overlay").addEventListener("click", () => {
                        document.querySelector("#responsive-overlay").classList.remove("active"), console.log(r.id), J();
                    })),
    ...
    (r.className = "custome-tooltip"),
        ...
        t.forEach((o) => {
            o.addEventListener("mouseenter", () => {
                r.style.setProperty("display", "block"), (r.textContent = o.querySelector(".side-menu__label").textContent), document.querySelector("html").getAttribute("data-vertical-style") == "doublemenu" && o.appendChild(r);
            }),
                o.addEventListener("mouseleave", () => {
                    r.style.setProperty("display", "none"), (r.textContent = o.querySelector(".side-menu__label").textContent), document.querySelector("html").getAttribute("data-vertical-style") == "doublemenu" && o.removeChild(r);
                });
        });
}
function Wr() {
...
function Nr() {
    document.querySelector("html").setAttribute("data-nav-style", "icon-hover"), S(), b();
}
function E() {
                ...
                if ((r.closest("ul:not(.main-menu)"), o)) {
                    if ((o.classList.add("active"), o.previousElementSibling.classList.add("active"), o.parentElement.classList.add("active"), o.parentElement.classList.contains("has-sub"))) {
                        ...
                        l.classList.add("open", "active"),
                            ...
                            (l.children[1].style.display = "block"),
                            Array.from(l.children[1].children).map((n) => {
...
function b() {
    document.querySelectorAll("ul.slide-menu").forEach((t) => {
        ...
        if (r) {
            let l = r.closest("ul.main-menu");
            for (; l; ) r.classList.add("active"), Z(r), (r = r.parentElement.closest("ul")), (o = r.closest("ul:not(.main-menu)")), o || (l = !1);
        }
    });
}
function Yr() {
    ...
    ee(),
        e.addEventListener("click", () => {
            let o = document.querySelector(".main-menu"),
                ...
                h = l.offsetWidth;
            o.scrollWidth > l.offsetWidth
                ? document.querySelector("html").getAttribute("dir") !== "rtl"
                    ? n < 0 && !(Math.abs(n) < h)
                        ? ((o.style.marginRight = 0), (o.style.marginLeft = Number(o.style.marginLeft.split("px")[0]) + Math.abs(h) + "px"), t.classList.remove("d-none"))
                        : (n >= 0, (o.style.marginLeft = "0px"), e.classList.add("d-none"), t.classList.remove("d-none"))
                    : u < 0 && !(Math.abs(u) < h)
                    ? ((o.style.marginLeft = 0), (o.style.marginRight = Number(o.style.marginRight.split("px")[0]) + Math.abs(h) + "px"), t.classList.remove("d-none"))
                    : (u >= 0, (o.style.marginRight = "0px"), e.classList.add("d-none"), t.classList.remove("d-none"))
                : ((document.querySelector(".main-menu").style.marginLeft = "0px"), (document.querySelector(".main-menu").style.marginRight = "0px"), e.classList.add("d-none"));
...
function ee() {
    ...
    e.scrollWidth > t.offsetWidth ? (o.classList.remove("d-none"), r.classList.add("d-none")) : ( r.classList.add("d-none"), (e.style.marginLeft = "0px"), (e.style.marginRight = "0px")),
        document.querySelector("html").getAttribute("dir") !== "rtl"
            ? (e.scrollWidth > t.offsetWidth && Math.abs(u) < Math.abs(l) && ((e.style.marginLeft = -u + "px"), r.classList.remove("d-none")), l == 0 ? r.classList.add("d-none") : r.classList.remove("d-none"))
            : (e.scrollWidth > t.offsetWidth && Math.abs(u) < Math.abs(n) && ((e.style.marginRight = -u + "px"), r.classList.remove("d-none")), n == 0 ? r.classList.add("d-none") : r.classList.remove("d-none")),
        (l != 0 || n != 0) && r.classList.remove("d-none");
}
["switcher-icon-click", "switcher-icon-hover", "switcher-horizontal"].map((e) => {
    document.getElementById(e) &&
        document.getElementById(e).addEventListener("click", () => {
            ...
            setTimeout(() => {
                t.offsetWidth > r.offsetWidth ? document.getElementById("slide-right").classList.remove("d-none") : document.getElementById("slide-right").classList.add("d-none");
            }, 100);
        });
});
function Xr() {
    window.innerWidth >= 992 &&
        (document.querySelector("html"),
        document.querySelectorAll(".main-menu > li > .side-menu__item").forEach((t) => {
        ...
        (r.classList.contains("double-menu-active") ||
            (document.querySelector(".slide-menu") &&
                document.querySelectorAll(".slide-menu").forEach((l) => {
                    l.classList.contains("double-menu-active") && (l.classList.remove("double-menu-active"), t.setAttribute("data-toggled", "double-menu-close"));
                }),
            r.classList.add("double-menu-active"),
            t.setAttribute("data-toggled", "double-menu-open")));
}
window.addEventListener("unload", () => {
    document.querySelector(".main-content").removeEventListener("click", b), window.removeEventListener("resize", O), document.querySelectorAll(".main-menu li > .side-menu__item").forEach((r) => r.removeEventListener("click", Me));
});
let _r = () => {
...
(function () {
    document.querySelector("html"),
        (zt = document.querySelector(".main-content")),
...
function jr() {
    ...
    (l = document.querySelector("#switcher-light-theme")),
        ...
        (u = document.querySelector("#switcher-boxed")),
        (h = document.querySelector("#switcher-full-width")),
        (x = document.querySelector("#switcher-menu-fixed")),
        (v = document.querySelector("#switcher-menu-scroll")),
        (B = document.querySelector("#switcher-header-fixed")),
        ...
        (R = document.querySelector("#switcher-header-primary")),
        (d = document.querySelector("#switcher-header-gradient")),
        (Oe = document.querySelector("#switcher-header-transparent")),
        (M = document.querySelector("#switcher-menu-light")),
        (De = document.querySelector("#switcher-menu-dark")),
        (Te = document.querySelector("#switcher-menu-primary")),
        (Pe = document.querySelector("#switcher-menu-gradient")),
        (Re = document.querySelector("#switcher-menu-transparent")),
        (He = document.querySelector("#switcher-regular")),
        (Fe = document.querySelector("#switcher-classic")),
        (ze = document.querySelector("#switcher-modern")),
        ($e = document.querySelector("#switcher-default-menu")),
        (Xe = document.querySelector("#switcher-menu-click")),
        (_e = document.querySelector("#switcher-menu-hover")),
        (je = document.querySelector("#switcher-icon-click")),
        (Ve = document.querySelector("#switcher-icon-hover")),
        (We = document.querySelector("#switcher-closed-menu")),
        (Ge = document.querySelector("#switcher-icontext-menu")),
        (Ne = document.querySelector("#switcher-icon-overlay")),
        (Ye = document.querySelector("#switcher-double-menu")),
        (Je = document.querySelector("#switcher-detached")),
        document.querySelector("#resetbtn"),
        (Ue = document.querySelector("#switcher-primary")),
        (Ke = document.querySelector("#switcher-primary1")),
        (Qe = document.querySelector("#switcher-primary2")),
        (Ze = document.querySelector("#switcher-primary3")),
        (et = document.querySelector("#switcher-primary4")),
        (tt = document.querySelector("#switcher-background")),
        (rt = document.querySelector("#switcher-background1")),
        (ot = document.querySelector("#switcher-background2")),
        (at = document.querySelector("#switcher-background3")),
        (lt = document.querySelector("#switcher-background4")),
        (nt = document.querySelector("#switcher-bg-img")),
        (st = document.querySelector("#switcher-bg-img1")),
        (it = document.querySelector("#switcher-bg-img2")),
        (ct = document.querySelector("#switcher-bg-img3")),
        (dt = document.querySelector("#switcher-bg-img4")),
        (ut = document.querySelector("#reset-all")),
        (mt = document.querySelector("#switcher-loader-enable")),
        (ht = document.querySelector("#switcher-loader-disable")),
        Ue.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "58, 88, 146"), a.style.setProperty("--primary-rgb", "58, 88, 146"), q();
        }),
        Ke.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "92, 144, 163"), a.style.setProperty("--primary-rgb", "92, 144, 163"), q();
        }),
        Qe.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "161, 90, 223"), a.style.setProperty("--primary-rgb", "161, 90, 223"), q();
        }),
        Ze.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "78, 172, 76"), a.style.setProperty("--primary-rgb", "78, 172, 76"), q();
        }),
        et.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "223, 90, 90"), a.style.setProperty("--primary-rgb", "223, 90, 90"), q();
        }),
        tt.addEventListener("click", () => {
            localStorage.setItem("bodyBgRGB", "20, 30, 96"),
                localStorage.setItem("bodylightRGB", "25, 38, 101"),
                a.setAttribute("data-theme-mode", "dark"),
        ...
        nt.addEventListener("click", () => {
            a.setAttribute("data-bg-img", "bgimg1"), localStorage.setItem("bgimg", "bgimg1");
        }),
        st.addEventListener("click", () => {
            a.setAttribute("data-bg-img", "bgimg2"), localStorage.setItem("bgimg", "bgimg2");
        }),
        it.addEventListener("click", () => {
            a.setAttribute("data-bg-img", "bgimg3"), localStorage.setItem("bgimg", "bgimg3");
        }),
        ct.addEventListener("click", () => {
            a.setAttribute("data-bg-img", "bgimg4"), localStorage.setItem("bgimg", "bgimg4");
        }),
        dt.addEventListener("click", () => {
            a.setAttribute("data-bg-img", "bgimg5"), localStorage.setItem("bgimg", "bgimg5");
        }),
        l.addEventListener("click", () => {
            Wt(), localStorage.setItem("ynexHeader", "light"), localStorage.removeItem("bodylightRGB"), localStorage.removeItem("bodyBgRGB"), localStorage.removeItem("ynexMenu");
        }),
        n.addEventListener("click", () => {
            Ur(), localStorage.setItem("ynexMenu", "dark"), localStorage.setItem("ynexHeader", "dark");
        }),
        M.addEventListener("click", () => {
            a.setAttribute("data-menu-styles", "light"), localStorage.setItem("ynexMenu", "light");
        }),
        Te.addEventListener("click", () => {
            a.setAttribute("data-menu-styles", "color"), localStorage.setItem("ynexMenu", "color");
        }),
        De.addEventListener("click", () => {
            a.setAttribute("data-menu-styles", "dark"), localStorage.setItem("ynexMenu", "dark");
        }),
        Pe.addEventListener("click", () => {
            a.setAttribute("data-menu-styles", "gradient"), localStorage.setItem("ynexMenu", "gradient");
        }),
        Re.addEventListener("click", () => {
            a.setAttribute("data-menu-styles", "transparent"), localStorage.setItem("ynexMenu", "transparent");
        }),
        C.addEventListener("click", () => {
            a.setAttribute("data-header-styles", "light"), localStorage.setItem("ynexHeader", "light");
        }),
        R.addEventListener("click", () => {
            a.setAttribute("data-header-styles", "color"), localStorage.setItem("ynexHeader", "color");
        }),
        A.addEventListener("click", () => {
            a.setAttribute("data-header-styles", "dark"), localStorage.setItem("ynexHeader", "dark");
        }),
        d.addEventListener("click", () => {
            a.setAttribute("data-header-styles", "gradient"), localStorage.setItem("ynexHeader", "gradient");
        }),
        Oe.addEventListener("click", () => {
            a.setAttribute("data-header-styles", "transparent"), localStorage.setItem("ynexHeader", "transparent");
        }),
        h.addEventListener("click", () => {
            a.setAttribute("data-width", "fullwidth"), localStorage.setItem("ynexfullwidth", !0), localStorage.removeItem("ynexboxed");
        }),
        u.addEventListener("click", () => {
            a.setAttribute("data-width", "boxed"), localStorage.setItem("ynexboxed", !0), localStorage.removeItem("ynexfullwidth"), ee();
        }),
        He.addEventListener("click", () => {
            a.setAttribute("data-page-style", "regular"), localStorage.setItem("ynexregular", !0), localStorage.removeItem("ynexclassic"), localStorage.removeItem("ynexmodern");
        }),
        Fe.addEventListener("click", () => {
            a.setAttribute("data-page-style", "classic"), localStorage.setItem("ynexclassic", !0), localStorage.removeItem("ynexregular"), localStorage.removeItem("ynexmodern");
        }),
        ze.addEventListener("click", () => {
            a.setAttribute("data-page-style", "modern"), localStorage.setItem("ynexmodern", !0), localStorage.removeItem("ynexregular"), localStorage.removeItem("ynexclassic");
        }),
        B.addEventListener("click", () => {
            a.setAttribute("data-header-position", "fixed"), localStorage.setItem("ynexheaderfixed", !0), localStorage.removeItem("ynexheaderscrollable");
        }),
        y.addEventListener("click", () => {
            a.setAttribute("data-header-position", "scrollable"), localStorage.setItem("ynexheaderscrollable", !0), localStorage.removeItem("ynexheaderfixed");
        }),
        x.addEventListener("click", () => {
            a.setAttribute("data-menu-position", "fixed"), localStorage.setItem("ynexmenufixed", !0), localStorage.removeItem("ynexmenuscrollable");
        }),
        v.addEventListener("click", () => {
            a.setAttribute("data-menu-position", "scrollable"), localStorage.setItem("ynexmenuscrollable", !0), localStorage.removeItem("ynexmenufixed");
        }),
        $e.addEventListener("click", () => {
            a.setAttribute("data-vertical-style", "default"),
                ...
                document.querySelectorAll(".main-menu>li.open").forEach((s) => {
                    s.classList.contains("active") || (s.classList.remove("open"), (s.querySelector("ul").style.display = "none"));
                });
        }),
        ...
        Je.addEventListener("click", () => {
            Fr(), localStorage.setItem("ynexverticalstyles", "detached");
        }),
        Ge.addEventListener("click", () => {
            zr(), localStorage.setItem("ynexverticalstyles", "icontext");
        }),
        ...
        Ye.addEventListener("click", () => {
            $r(), localStorage.setItem("ynexverticalstyles", "doublemenu");
        }),
        Xe.addEventListener("click", () => {
            a.removeAttribute("data-vertical-style"),
                ...
                document.querySelector("html").getAttribute("data-nav-layout") == "horizontal" && ((document.querySelector(".main-menu").style.marginLeft = "0px"), (document.querySelector(".main-menu").style.marginRight = "0px"), O());
        }),
        ...
        je.addEventListener("click", () => {
            a.removeAttribute("data-vertical-style"),
                ...
                localStorage.removeItem("ynexverticalstyles"),
                document.querySelector("html").getAttribute("data-nav-layout") == "horizontal" &&
                    ((document.querySelector(".main-menu").style.marginLeft = "0px"), (document.querySelector(".main-menu").style.marginRight = "0px"), O(), document.querySelector("#slide-left").classList.add("d-none")),
                document.querySelectorAll(".main-menu>li.open").forEach((s) => {
                    s.classList.contains("active") || (s.classList.remove("open"), (s.querySelector("ul").style.display = "none"));
                });
        }),
        ...
        r.addEventListener("click", () => {
            ...
            localStorage.removeItem("ynexlayout"),
                ...
                document.querySelectorAll(".slide").forEach((te) => {
                    te.classList.contains("open") && !te.classList.contains("active") && (te.querySelector("ul").style.display = "none");
                });
        }),
        ...
        ut.addEventListener("click", () => {
            Qr(),
                ...
                document.querySelectorAll(".slide").forEach((s) => {
                    s.classList.contains("open") && !s.classList.contains("active") && (s.querySelector("ul").style.display = "none");
                });
        }),
        (mt.onclick = () => {
...
function $t() {
    var t;
    let e = document.querySelector("html");
    document.querySelector("#style").href.includes("bootstrap.min.css") || (t = document.querySelector("#style")) == null || t.setAttribute("href", "https://laravelui.spruko.com/ynex/build/assets/libs/bootstrap/css/bootstrap.min.css"),
...
function Kr() {
    ...
    e.setAttribute("data-nav-layout", "horizontal"),
        ...
        e.getAttribute("data-nav-style") || e.setAttribute("data-nav-style", "menu-click"),
        !localStorage.ynexMenu && !localStorage.bodylightRGB && (e.setAttribute("data-menu-styles", "light"), (document.querySelector("#switcher-menu-light").checked = !0), L()),
        L(),
        ee();
}
function Qr() {
    ...
    localStorage.getItem("ynexlayout") == "horizontal" && (document.querySelector(".main-menu").style.display = "block"),
        ...
        e.removeAttribute("data-bg-img"),
        e.style.removeProperty("--primary-rgb"),
        e.style.removeProperty("--body-bg-rgb"),
        $t(),
        Gt(),
        zt.removeEventListener("click", b),
...
function L() {
    if (
        (localStorage.getItem("ynexdarktheme") && (document.querySelector("#switcher-dark-theme").checked = !0),
...
let i, gt;
function q() {
    (gt = getComputedStyle(document.documentElement).getPropertyValue("--primary-rgb").trim()),
        (i = localStorage.getItem("primaryRGB") || gt),
        document.querySelector("#crm-total-customers") !== null && Yt(i),
        document.querySelector("#crm-revenue-analytics") !== null && Xt(i),
        document.querySelector("#crm-profits-earned") !== null && jt(i),
        document.querySelector("#leads-source") !== null && Vt(i),
        document.querySelector("#earnings") !== null && Kt(i),
        document.querySelector("#crypto") !== null && Zt(i),
        document.querySelector("#subscriptionOverview") !== null && er(i),
        document.querySelector("#candidates-chart") !== null && tr(i),
        document.querySelector("#nft-balance-chart") !== null && rr(i),
        document.querySelector("#nft-statistics") !== null && ar(i),
        document.querySelector("#salesOverview") !== null && lr(i),
        document.querySelector("#sale-value") !== null && nr(i),
        document.querySelector("#analytics-bouncerate") !== null && ir(i),
        document.querySelector("#sessions") !== null && cr(i),
        document.querySelector("#audienceReport") !== null && dr(i),
        document.querySelector("#country-sessions") !== null && ur(i),
        document.querySelector("#session-users") !== null && hr(i),
        document.querySelector("#projectAnalysis") !== null && br(i),
        document.querySelector("#performanceReport") !== null && pr(i),
        document.querySelector("#jobs-summary") !== null && wr(i),
        document.querySelector("#total-invested") !== null && vr(i),
        document.querySelector("#totalInvestmentsStats") !== null && xr(i),
        document.querySelector("#stocks-marketcap") !== null && Sr(i),
        document.querySelector("#courses-earnings") !== null && qr(i),
        document.querySelector("#course-payouts") !== null && Lr(i),
        document.querySelector("#waterTrack") !== null && Br(i),
        document.querySelector("#report") !== null && Ir(i),
        document.querySelector("#views") !== null && Cr(i);
}
if (document.querySelector("#switcher-canvas")) {
    const e = document.querySelector(".pickr-container-primary"),
        ...
        l = [["nano", { defaultRepresentation: "RGB", components: { preview: !0, opacity: !1, hue: !0, interaction: { hex: !1, rgba: !0, hsva: !1, input: !0, clear: !1, save: !1 } } }]],
        n = [];
    let u = null;
    for (const [v, B] of l) {
        ...
        (x.innerHTML = v),
            ...
            x.addEventListener("click", () => {
                ...
                (u = new Pickr(Object.assign({ el: C, theme: v, default: "#845adf" }, B))),
                    u.on("changestop", (A, R) => {
                        let d = R.getColor().toRGBA();
                        document.querySelector("html").style.setProperty("--primary-rgb", `${Math.floor(d[0])}, ${Math.floor(d[1])}, ${Math.floor(d[2])}`),
                            localStorage.setItem("primaryRGB", `${Math.floor(d[0])}, ${Math.floor(d[1])}, ${Math.floor(d[2])}`),
                            q();
                    });
            }),
            t.appendChild(x);
    ...
    for (const [v, B] of l) {
        ...
        (x.innerHTML = v),
            ...
            x.addEventListener("click", () => {
                ...
                for (const A of n) A.classList[A === x ? "add" : "remove"]("active");
                (y = new Pickr(Object.assign({ el: C, theme: v, default: "#845adf" }, B))),
                    y.on("changestop", (A, R) => {
                        let d = R.getColor().toRGBA(),
                            M = document.querySelector("html");
                        M.style.setProperty("--body-bg-rgb", `${d[0]}, ${d[1]}, ${d[2]}`),
                            document.querySelector("html").style.setProperty("--body-bg-rgb2", `${d[0] + 14}, ${d[1] + 14}, ${d[2] + 14}`),
                            document.querySelector("html").style.setProperty("--light-rgb", `${d[0] + 14}, ${d[1] + 14}, ${d[2] + 14}`),
                            document.querySelector("html").style.setProperty("--form-control-bg", `rgb(${d[0] + 14}, ${d[1] + 14}, ${d[2] + 14})`),
                            localStorage.removeItem("bgtheme"),
                            q(),
                            M.setAttribute("data-theme-mode", "dark"),
                            M.setAttribute("data-menu-styles", "dark"),
                            M.setAttribute("data-header-styles", "dark"),
                            (document.querySelector("#switcher-dark-theme").checked = !0),
                            localStorage.setItem("bodyBgRGB", `${d[0]}, ${d[1]}, ${d[2]}`),
                            localStorage.setItem("bodylightRGB", `${d[0] + 14}, ${d[1] + 14}, ${d[2] + 14}`);
                    });
            }),
            o.appendChild(x);
    }
...
function Zr() {
    (localStorage.bodyBgRGB || localStorage.bodylightRGB) &&
        ((document.querySelector("#switcher-dark-theme").checked = !0), (document.querySelector("#switcher-menu-dark").checked = !0), (document.querySelector("#switcher-header-dark").checked = !0)),
        localStorage.bodyBgRGB &&
            localStorage.bodylightRGB &&
            (localStorage.bodyBgRGB == "20, 30, 96" && (document.querySelector("#switcher-background").checked = !0),
            localStorage.bodyBgRGB == "8, 78, 115" && (document.querySelector("#switcher-background1").checked = !0),
            localStorage.bodyBgRGB == "90, 37, 135" && (document.querySelector("#switcher-background2").checked = !0),
            localStorage.bodyBgRGB == "24, 101, 51" && (document.querySelector("#switcher-background3").checked = !0),
            localStorage.bodyBgRGB == "120, 66, 20" && (document.querySelector("#switcher-background4").checked = !0)),
        localStorage.primaryRGB &&
            (localStorage.primaryRGB == "58, 88, 146" && (document.querySelector("#switcher-primary").checked = !0),
